...
plt.figure(2)
plt.plot(position_mu_adim_10, u_mean_adim_10, label="r/D = 1.0 exp", color='blue', markersize=5, linewidth=2)
plt.plot(position_mu_fluent_adim_10[:70], u_mean_fluent_adim_10[:70], label="r/D = 1.0 Fluent", color='orange', markersize=5, linewidth=2)
plt.plot(position_mu_wall_adim_10[:70], u_mean_wall_adim_10[:70], label="r/D = 1.0 Fluent Wall", color='red', markersize=5, linewidth=2)
...
plt.figure(3)
plt.plot(position_mu_adim_30, u_mean_adim_30, label="r/D = 3.0 exp", color='blue', markersize=5, linewidth=2)
plt.plot(position_mu_fluent_adim_30[:70], u_mean_fluent_adim_30[:70], label="r/D = 3.0 Fluent", color='orange', markersize=5, linewidth=2)
plt.plot(position_mu_wall_adim_30[:70], u_mean_wall_adim_30[:70], label="r/D = 3.0 Fluent Wall", color='red', markersize=5, linewidth=2)
plt.xlabel("Position y/D")
plt.ylabel("vitesse u/UBULK")
...
plt.plot(position_k_fluent_dim_10[:70], k_fluent_dim_10[:70], label="r/D = 1.0 Fluent")
plt.plot(position_k_wall_dim_10[:70], k_wall_dim_10[:70], label="r/D = 1.0 Fluent Wall")
...
plt.plot(position_k_wall_dim_30[:70], k_wall_dim_30[:70], label="r/D = 3.0 Fluent Wall")
plt.xlabel("Position y")
plt.ylabel("k")
plt.grid()
plt.title("Profil d'énergie cinétique turbulente")
...
plt.plot(position_Nu_adim_fluent[:125] ,Nu_fluent[:125]/(Re**0.7), label="fluent")
plt.plot(position_Nu_adim_wall[:125] ,Nu_wall[:125]/(Re**0.7), label="fluent wall")
