...
plt.figure(2)
plt.plot(position_mu_adim_10, u_mean_adim_10, 'o-', label="r/D = 1.0 exp", color='blue', markersize=5, linewidth=2)
plt.plot(position_mu_fluent_adim_10[:70], u_mean_fluent_adim_10[:70], 's-', label="r/D = 1.0 Fluent", color='orange', markersize=5, linewidth=2)
plt.plot(position_mu_star_adim_10[:40], u_mean_star_adim_10[:40], '*-', label="r/D = 1.0 Starccm", color='green', markersize=5, linewidth=2)
plt.xlabel("Position y/D")
plt.ylabel("vitesse u/UBULK")
plt.title("Profil de vitesse moyenne")
plt.legend()
plt.grid()
plt.savefig("comp-u_mean_adim_1d.png")

plt.figure(3)
plt.plot(position_mu_adim_30, u_mean_adim_30, 'o-', label="r/D = 3.0 exp", color='blue', markersize=5, linewidth=2)
plt.plot(position_mu_fluent_adim_30[:70], u_mean_fluent_adim_30[:70], 's-', label="r/D = 3.0 Fluent", color='orange', markersize=5, linewidth=2)
plt.plot(position_mu_star_adim_30[:40], u_mean_star_adim_30[:40], '*-', label="r/D = 3.0 Starccm", color='green', markersize=5, linewidth=2)
plt.xlabel("Position y/D")
plt.ylabel("vitesse u/UBULK")
plt.title("Profil de vitesse moyenne")
plt.legend()
...
# StarCCM
position_k_star_dim_10, k_star_dim_10, position_k_star_adim_10 , k_star_adim_10, position_k_star_dim_30, k_star_dim_30, position_k_star_adim_30 , k_star_adim_30= lecture_starccm_double('kinetic.csv', \
                                                                                    0.208, 1/D, 0, 1/u_bulk, 0.208, 1/D, 0, 1/u_bulk)
position_k_star_adim_10, k_star_adim_10 = sort(position_k_star_adim_10, k_star_adim_10)
position_k_star_adim_30, k_star_adim_30 = sort(position_k_star_adim_30, k_star_adim_30)
position_k_star_dim_10, k_star_dim_10 = sort(position_k_star_dim_10, k_star_dim_10)
position_k_star_dim_30, k_star_dim_30 = sort(position_k_star_dim_30, k_star_dim_30)
...
plt.plot(position_k_star_dim_10[:40], k_star_dim_10[:40], '*-', label="r/D = 1.0 Starccm")
plt.xlabel("Position y")
plt.ylabel("k")
plt.grid()
plt.title("Profil d'énergie cinétique turbulente")
plt.legend()
plt.savefig("comp_k_dim_1d.png")
...
plt.plot(position_k_star_dim_30[:40], k_star_dim_30[:40], '*-', label="r/D = 3.0 Starccm")
plt.xlabel("Position y")
plt.ylabel("k")
plt.grid()
plt.title("Profil d'énergie cinétique turbulente")
plt.legend()
plt.savefig("comp_k_dim_3d.png")
